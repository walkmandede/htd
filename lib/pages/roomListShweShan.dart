...
class ShweShanList extends StatefulWidget {
  @override
  _ShweShanListState createState() => _ShweShanListState();
}

class _ShweShanListState extends State<ShweShanList> {
  String me;
          ...
          FlatButton(
            ...
            onPressed: () async {
              ...
              DocumentReference dr =
                  await Firestore.instance.collection('ShweShan').document(roomId);
              List<Map> cards = [];
              dr.setData({
                'state': 'Waiting',
                ...
                'players': {
                  sp.getString('currentUser'): {
                    'cards': '','show':false,'draw':false,
                  }
                }
              });
              Navigator.of(context, rootNavigator: true).pushReplacement(
                  MaterialPageRoute(builder: (context) => ShweShan(roomId)));
            },
          )
        ],
      ),
      body: StreamBuilder(
          stream: Firestore.instance.collection("ShweShan").snapshots(),
          builder:
                      ...
                      child: Column(
                        children: [
                          Row(
                            ...
                            children: [
                              Text('ShweShan# - ${room.documentID.substring(6)}'),
