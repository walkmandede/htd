...
class ChatGroupForm extends StatefulWidget {
  const ChatGroupForm();

  @override
  _ChatGroupFormState createState() => _ChatGroupFormState();
}

class _ChatGroupFormState extends State<ChatGroupForm> {
  ...
  void getData() async {
    ...
    groupCR = Firestore.instance.collection('group_chat');
                    ...
                    children: [
                      ...
                      FlatButton(
                        ...
                        onPressed: () async {
                          ...
                          Firestore.instance.collection('group_chat').add({
