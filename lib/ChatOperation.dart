...
class ChatOperation extends StatelessWidget {
  const ChatOperation();
...
class ChatOperationForm extends StatefulWidget {
  const ChatOperationForm();

  @override
  _ChatOperationFormState createState() => _ChatOperationFormState();
}

class _ChatOperationFormState extends State<ChatOperationForm> {
  ...
  void getData() async {
    ...
    groupCR = Firestore.instance.collection('operation_chat');
                    ...
                    children: [
                      ...
                      FlatButton(
                        ...
                        onPressed: () async {
                          ...
                          Firestore.instance.collection('operation_chat').add({
